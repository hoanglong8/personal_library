...
07 — Thiết kế Canvas — Đồ họa mạng xã hội, áp phích, bìa — nhập văn bản, xuất PNG/PDF. 
[canvas-design](https://github.com/anthropics/skills/tree/main/skills/canvas-design)

08 — Nghệ thuật Thuật toán — Họa tiết fractal, bố cục hình học qua p5.js. 
[algorithmic-art](https://github.com/anthropics/skills/tree/main/skills/algorithmic-art)

09 — Theme Factory — Tạo hàng loạt bảng màu từ một prompt. 
[theme-factory](https://github.com/anthropics/skills/tree/main/skills/theme-factory)

10 — Web Artifacts Builder — Máy tính, bảng điều khiển thông qua ngôn ngữ tự nhiên. Không cần kỹ năng frontend.
[web-artifacts-builder](https://github.com/anthropics/skills/tree/main/skills/web-artifacts-builder)

## Phát triển & Kỹ thuật 👨‍💻
11 — Superpowers — Hơn 20 kỹ năng đã được kiểm chứng. TDD, gỡ lỗi, quy trình lập kế hoạch đến thực thi. [https://github.com/obra/superpowers
](https://github.com/obra/superpowers
)
12 — Gỡ lỗi Hệ thống — Phân tích nguyên nhân gốc rễ trước, sửa lỗi sau. Phương pháp 4 giai đoạn. S9.2 trên SkillHub. [Hermes AI](https://hermes.ai.vn/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging/)

13 — Tìm kiếm Tập tin — Ripgrep + ast-grep thành thạo. Đánh giá S9.0. [https://github.com/massgen/massgen](https://github.com/massgen/massgen)

14 — Tối ưu hóa Ngữ cảnh — Giảm chi phí token, thủ thuật KV-cache. 13.9k sao. [https://github.com/.../agent-skills-for-context-engineering](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering)

15 — Trình tạo Kỹ năng (Chính thức) — Siêu kỹ năng: mô tả quy trình làm việc, nhận SKILL.md trong 5 phút. [https://github.com/.../skills/tree/main/skills/skill-creator](https://github.com/anthropics/skills/tree/main/skills/skill-creator)

16 — Remotion Best Practices — Tạo video bằng AI. [https://github.com/remotion-dev/remotion](https://github.com/remotion-dev/remotion)

## Kiến thức & Học tập 🧠

20 — Tích hợp NotebookLM — Cầu nối Claude + NotebookLM. Tóm tắt, bản đồ tư duy, thẻ ghi nhớ. [https://github.com/PleasePrompto/notebooklm-skill](https://github.com/PleasePrompto/notebooklm-skill)

21 — Obsidian Skills — Bởi CEO của Obsidian. Tự động gắn thẻ, tự động liên kết, gốc vault. [https://github.com/kepano/obsidian-skills](https://github.com/kepano/obsidian-skills)

22 — Máy chủ Excel MCP — Thao tác Excel mà không cần Microsoft Excel. https://github.com/haris-musa/excel-mcp-server

23 - Duyệt qua hơn 80k kỹ năng cộng đồng: skillsmp.com

24 - Tavily
Công cụ tìm kiếm được xây dựng cho các tác nhân AI. Không phải liên kết màu xanh — dữ liệu có cấu trúc sạch sẽ. Bốn công cụ: tìm kiếm, trích xuất, thu thập dữ liệu, bản đồ. Kết nối như MCP từ xa trong một phút.
[https://github.com/tavily-ai/tavily-mcp](https://github.com/tavily-ai/tavily-mcp)

25 - Context7
Chèn tài liệu thư viện cập nhật vào ngữ cảnh của LLM. Không còn API bị ảo giác. Không còn phương thức lỗi thời. Chỉ cần thêm "use context7" vào prompt của bạn. Hỗ trợ Next.js, React, Supabase, MongoDB, hàng ngàn cái khác.
[https://github.com/upstash/context7](https://github.com/upstash/context7)

26 - Task Master AI
Quản lý dự án của AI. Cung cấp PRD → các nhiệm vụ có cấu trúc với phụ thuộc → Claude thực thi từng cái một. Biến các phiên hỗn loạn thành một quy trình thích hợp. Hoạt động trên Cursor, Claude Code, Windsurf.
[https://github.com/eyaltoledano/claude-task-master](https://github.com/eyaltoledano/claude-task-master)

## Agent Frameworks

23 — OpenClaw — Tác nhân AI lan truyền. Bền bỉ, đa kênh, tự viết kỹ năng của riêng nó. Hơn 210k sao. [https://github.com/openclaw/openclaw](https://github.com/openclaw/openclaw)

24 — AutoGPT — Nền tảng tác nhân đầy đủ cho các tác vụ chạy dài. [https://github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)

25 — LangGraph — Tác nhân dưới dạng đồ thị. Điều phối đa tác nhân. 26.8k sao. [https://github.com/langchain-ai/langgraph](https://github.com/langchain-ai/langgraph)

26 — OWL — Hợp tác đa tác nhân. Đứng đầu chuẩn GAIA. [https://github.com/camel-ai/owl](https://github.com/camel-ai/owl)

27 — Dify — Trình xây dựng ứng dụng LLM mã nguồn mở. Quy trình làm việc, RAG, tác nhân tất cả trong một. [https://github.com/langgenius/dify](https://github.com/langgenius/dify)

28 — CrewAI — Đa tác nhân với vai trò, mục tiêu, câu chuyện nền. [https://github.com/crewAIInc/crewAI](https://github.com/crewAIInc/crewAI)

29 — CopilotKit — Nhúng copilot AI vào ứng dụng React. [https://github.com/CopilotKit/CopilotKit](https://github.com/CopilotKit/CopilotKit)

## Local AI

30 — Ollama — Chạy LLM cục bộ với một lệnh. [https://github.com/ollama/ollama](https://github.com/ollama/ollama)

31 — Open WebUI — Giao diện giống ChatGPT tự lưu trữ. [https://github.com/open-webui/open-webui](https://github.com/open-webui/open-webui)

32 — LlamaFile — LLM dưới dạng một tệp thực thi duy nhất. Không phụ thuộc. [https://github.com/Mozilla-Ocho/llamafile](https://github.com/Mozilla-Ocho/llamafile)

33 — Unsloth — Tinh chỉnh nhanh hơn 2 lần, giảm 70% bộ nhớ. [https://github.com/unslothai/unsloth](https://github.com/unslothai/unsloth)

## Workflow & Automation

34 — n8n — Open-source automation, 400+ integrations + AI nodes. [https://github.com/n8n-io/n8n](https://github.com/n8n-io/n8n)
